...
public class EmailTokenDbExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addTokenTypeCriterion(String condition, Object value, String property) {
            ...
            tokenTypeCriteria.add(new Criterion(condition, value, "com.killeen.taskflow.db.typehandler.PostgresEnumTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addTokenTypeCriterion(String condition, String value1, String value2, String property) {
            ...
            tokenTypeCriteria.add(new Criterion(condition, value1, value2, "com.killeen.taskflow.db.typehandler.PostgresEnumTypeHandler"));
            allCriteria = null;
        }
